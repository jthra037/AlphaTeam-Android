...
public class LevelGenerator
{
    ...
    LevelGenerator(World w, int density)
    {
        ...
        placedObstacles.add(new ObRectangle(w.game, w, w.getPlayer().getWorldCoord(), new ITuple(screenSize.x - (screenSize.x / 10),screenSize.y - (screenSize.y / 10)), 0));
        ...
        for (int i = 0; i < obstacleCount; i++)
        {
            ...
            placedObstacles.add(new ObRectangle(w.game, w, pos, size, color));
